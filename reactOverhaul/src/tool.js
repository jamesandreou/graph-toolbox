...
export class Tool extends Component{
	...
	render(){
		...
		return (
			<div onClick={this.props.onClickEvent} onMouseEnter={this.handleMouseEnter.bind(this)} onMouseLeave={this.handleMouseLeave.bind(this)} style={style}>
				<svg viewBox="0 0 64 64" width={this.props.size * 0.9} height={this.props.size * 0.9} preserveAspectRatio="xMidYMid meet" fitstyle={svgStyle}>
			...
			case 'sel':
				return (
					...
					<path transform="rotate(-26.727214813232422 33.74142837524413,23.632715225219723) " id="svg_36" d="m32.02369,42.10813c-3.66549,-0.63617 -6.80387,-3.48182 -7.75547,-7.08627c-0.45189,-1.84002 -0.18725,-3.77017 -0.27666,-5.65029c-0.01659,-4.82576 -0.02488,-9.65154 -0.03805,-14.47732c0.43073,-1.49774 2.24733,-2.2856 3.62935,-1.54503c0.12017,-0.39384 0.03205,-1.09941 0.07425,-1.61045c-0.24533,-1.40498 0.75688,-2.83451 2.21226,-2.92964c0.8356,-0.00536 1.83554,0.62935 1.4548,-0.77605c-0.25815,-1.44796 0.87856,-3.09706 2.43278,-2.96359c1.48487,-0.13776 2.613,1.37358 2.434,2.77477c0.06848,0.83613 1.87987,-0.54834 2.51344,0.38159c0.80751,0.47922 1.35968,1.39376 1.2074,2.33897c0.04642,2.58993 -0.06372,5.19588 0.11728,7.77335c1.32818,-0.67235 3.22075,0.15377 3.49254,1.63247c-0.03014,4.59478 0.07658,9.19311 -0.08101,13.78543c-0.53476,4.72367 -5.02733,8.71801 -9.82306,8.43444c-0.53149,0.00134 -1.06741,0.00641 -1.59385,-0.08236zm3.27964,-1.25486c4.02623,-0.68027 7.19314,-4.57267 6.96658,-8.66544c0.03058,-3.95556 0.15577,-7.91736 0.00911,-11.87069c-0.09351,-1.44511 -2.4896,-1.09535 -2.33435,0.23827c-0.00076,2.9321 -0.00145,5.86403 -0.0023,8.79585c-0.74584,0.7692 -2.08118,0.3058 -2.97626,0.93092c-1.98842,0.86787 -3.25208,2.99262 -3.29499,5.13165c-1.07301,1.66331 -1.55851,-1.04366 -0.94336,-1.93517c0.71151,-2.68981 3.21437,-4.6965 5.96379,-4.95994c-0.02309,-6.18768 0.05789,-12.37795 -0.0724,-18.56376c-0.77864,-1.75246 -2.95971,-0.21537 -2.37883,1.31893c-0.05732,4.67804 -0.00639,9.35761 -0.08638,14.03546c-0.52015,0.83177 -1.50527,0.04293 -1.18382,-0.72455c-0.02221,-5.86016 -0.04444,-11.72045 -0.06657,-17.58063c-0.41703,-1.03489 -2.26525,-0.87305 -2.29453,0.26286c-0.02223,6.04748 -0.04524,12.09496 -0.06791,18.14238c-0.48647,0.68519 -1.48566,0.08949 -1.21694,-0.65841c-0.01769,-4.55501 0.05008,-9.11263 -0.06845,-13.6663c-0.02988,-1.35549 -2.29956,-1.32171 -2.33033,-0.06482c-0.04488,4.6692 0.01198,9.34134 -0.12445,14.00872c0.12893,1.18903 -1.54567,0.62184 -1.16,-0.27761c-0.02034,-3.17275 0.05577,-6.34933 -0.07382,-9.51966c-0.76318,-1.95581 -3.04556,-0.34106 -2.40912,1.28458c0.00715,5.62667 -0.05123,11.25598 0.09084,16.88112c0.34903,4.32156 4.50983,7.88004 8.83791,7.59609c0.40821,-0.01695 0.81514,-0.06371 1.21658,-0.13987l0,0z" strokeLinecap="null" strokeLinejoin="null" strokeDasharray="null" strokeWidth="0" stroke="#000000" fill={col}/>
  					<ellipse ry="5.30598" rx="5.30598" id="svg_38" cy="9.583" cx="18.79338" strokeLinecap="null" strokeLinejoin="null" strokeDasharray="null" strokeWidth="0" stroke="#000000" fill={col}/>
					<text fontWeight="bold" stroke={col} transform="matrix(0.3952723529750775,0,0,0.5559273971165859,17.229926784815113,25.804202517850843) " textAnchor="middle" fontFamily="Monospace" fontSize="22" y="59.58796" x="37.21191" strokeWidth="1" fill={col}>Select</text>
					</g>
				);
			case 'addv':
				return (
					<g>
					<ellipse stroke="#000000" ry="15.01694" rx="15.01694" id="svg_20" cy="24.70004" cx="26.29526" strokeLinecap="null" strokeLinejoin="null" strokeDasharray="null" strokeWidth="0" fill={col}/>
					<path id="svg_21" d="m37.11761,7.42582l5.38181,0l0,-5.38204l5.52096,0l0,5.38204l5.38227,0l0,5.52096l-5.38227,0l0,5.38204l-5.52096,0l0,-5.38204l-5.38181,0l0,-5.52096z" strokeLinecap="null" strokeLinejoin="null" strokeDasharray="null" strokeWidth="0" stroke="#000000" fill={col}/>
					<g id="svg_27">
					...
					<text fontWeight="bold" stroke={col} transform="matrix(0.3952723529750775,0,0,0.5559273971165859,17.229926784815113,25.804202517850843) " textAnchor="middle" fontFamily="Monospace" fontSize="22" y="59.58796" x="37.21191" strokeWidth="1" fill={col}>Add Vertice</text>
					</g>
				 );
			case 'adde':
				return (
					<g>
					<rect transform="rotate(-49.18491744995117 31.307498931884783,25.35078048706055) " id="svg_35" height="28.13173" width="2.00226" y="11.28491" x="30.30637" strokeLinecap="null" strokeLinejoin="null" strokeDasharray="null" strokeWidth="0" stroke="#000000" fill={col}/>
					<path id="svg_21" d="m37.11761,7.42582l5.38181,0l0,-5.38204l5.52096,0l0,5.38204l5.38227,0l0,5.52096l-5.38227,0l0,5.38204l-5.52096,0l0,-5.38204l-5.38181,0l0,-5.52096z" strokeLinecap="null" strokeLinejoin="null" strokeDasharray="null" strokeWidth="0" stroke="#000000" fill={col}/>
					<g stroke="null" id="svg_28">
					<ellipse stroke="#000000" ry="6.85773" rx="6.85773" id="svg_20" cy="13.43734" cx="17.23504" strokeLinecap="null" strokeLinejoin="null" strokeDasharray="null" strokeWidth="0" fill={col}/>
					...
					<ellipse id="svg_30" stroke="#000000" ry="6.85773" rx="6.85773" cy="35.01167" cx="45.02296" strokeLinecap="null" strokeLinejoin="null" strokeDasharray="null" strokeWidth="0" fill={col}/>
					...
					<text fontWeight="bold" stroke={col} transform="matrix(0.3952723529750775,0,0,0.5559273971165859,17.229926784815113,25.804202517850843) " textAnchor="middle" fontFamily="Monospace" fontSize="22" y="59.58796" x="37.21191" strokeWidth="1" fill={col}>Add Edge</text>
					</g>
				 );
			case 'dir':
				return (
					...
					<text fontWeight="bold" stroke={col} transform="matrix(0.3952723529750775,0,0,0.5559273971165859,17.229926784815113,25.804202517850843) " textAnchor="middle" fontFamily="Monospace" fontSize="22" y="59.58796" x="37.21191" strokeWidth="1" fill={col}>Directed</text>
					</g>
				 );
			case 'del':
				return (
					...
					<text fontWeight="bold" stroke={col} transform="matrix(0.3952723529750775,0,0,0.5559273971165859,17.229926784815113,25.804202517850843) " textAnchor="middle" fontFamily="Monospace" fontSize="22" y="59.58796" x="37.21191" strokeWidth="1" fill={col}>Delete</text>
					</g>
				 );
			case 'weight':
				return (
					...
					<text fontWeight="bold" stroke={col} transform="matrix(0.3952723529750775,0,0,0.5559273971165859,17.229926784815113,25.804202517850843) " textAnchor="middle" fontFamily="Monospace" fontSize="22" y="59.58796" x="37.21191" strokeWidth="1" fill={col}>Edge Weight</text>
					</g>
				 );
		}
	}
